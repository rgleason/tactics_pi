...
TacticsInstrument_Dial::TacticsInstrument_Dial( wxWindow *parent, wxWindowID id, wxString title, int cap_flag,
                  int s_angle, int r_angle, int s_value, int e_value) : TacticsInstrument(parent, id, title, cap_flag)
{
...
wxSize TacticsInstrument_Dial::GetSize( int orient, wxSize hint )
{
      wxClientDC dc(this);
      int w;
...
void TacticsInstrument_Dial::SetData(int st, double data, wxString unit)
{
