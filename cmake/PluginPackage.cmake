...
SET(PACKAGE_VERSION "${PLUGIN_VERSION_MAJOR}.${PLUGIN_VERSION_MINOR}.${PLUGIN_VERSION_PATCH}-${OCPN_MIN_VERSION}" )
...
#  set(APPS "\${CMAKE_INSTALL_PREFIX}/bin/OpenCPN.app")
  ...
  install(
    FILES ${PREFIX_PARENTLIB}/libtactics_pi.dylib
  ...
  MESSAGE(STATUS "osX package: ${CPACK_PACKAGE_FILE_NAME}, package_version: ${PACKAGE_VERSION}, package_release: ${PACKAGE_RELEASE}")
  add_custom_command(
