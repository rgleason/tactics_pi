...
class TacticsPreferencesDialogDef : public wxDialog
{
	...
	public:
		...
		TacticsPreferencesDialogDef( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Tactics Preferences"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 572,443 ), long style = wxDEFAULT_DIALOG_STYLE|wxSTAY_ON_TOP );
