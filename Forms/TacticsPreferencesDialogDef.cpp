...
TacticsPreferencesDialogDef::TacticsPreferencesDialogDef( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	m_buttonOK->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TacticsPreferencesDialogDef::OnTacticsPreferencesOKClick ), NULL, this );
	m_buttonCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TacticsPreferencesDialogDef::OnTacticsPreferencesCancelClick ), NULL, this );
	m_buttonApply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TacticsPreferencesDialogDef::OnTacticsPreferencesApplyClick ), NULL, this );
}

TacticsPreferencesDialogDef::~TacticsPreferencesDialogDef()
{
	// Disconnect Events
	m_buttonOK->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TacticsPreferencesDialogDef::OnTacticsPreferencesOKClick ), NULL, this );
	m_buttonCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TacticsPreferencesDialogDef::OnTacticsPreferencesCancelClick ), NULL, this );
	m_buttonApply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( TacticsPreferencesDialogDef::OnTacticsPreferencesApplyClick ), NULL, this );
