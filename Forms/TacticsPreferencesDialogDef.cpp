...
TacticsPreferencesDialogDef::TacticsPreferencesDialogDef( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_SizerItemBoxSizerMainPanel = new wxBoxSizer( wxVERTICAL );

	m_notebookPreferences = new wxNotebook( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxNB_TOP );
	...
	fgSizer6->Add( m_listCtrlTactics, 0, wxALL, 2 );
	...
	bSizer4->Add( m_bpButtonAddTactics, 0, wxALL, 2 );
	...
	fgSizer7->Add( m_choiceOrientation, 0, wxALIGN_RIGHT|wxALL, 2 );


	sbSizer1->Add( fgSizer7, 1, wxEXPAND, 2 );


	bSizer7->Add( sbSizer1, 1, wxEXPAND, 2 );


	fgSizer8->Add( bSizer7, 1, wxEXPAND, 2 );
	...
	fgSizer10->Add( bSizer10, 1, wxEXPAND, 2 );
	...
	m_staticText25 = new wxStaticText( sbSizer4->GetStaticBox(), wxID_ANY, _("Speedometer max value:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText25->Wrap( -1 );
	fgSizer12->Add( m_staticText25, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );
	...
	m_staticText481 = new wxStaticText( sbSizer4->GetStaticBox(), wxID_ANY, _("Speed Over Ground Damping Factor:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText481->Wrap( -1 );
	fgSizer12->Add( m_staticText481, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );

	m_spinCtrlSOGDamp = new wxSpinCtrl( sbSizer4->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0 );
	fgSizer12->Add( m_spinCtrlSOGDamp, 0, wxALIGN_RIGHT|wxALL, 0 );
	...
	fgSizer12->Add( m_staticText26, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );

	m_spinCtrlCOGDamp = new wxSpinCtrl( sbSizer4->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0 );
	fgSizer12->Add( m_spinCtrlCOGDamp, 0, wxALIGN_RIGHT|wxALL, 0 );

	m_staticText27 = new wxStaticText( sbSizer4->GetStaticBox(), wxID_ANY, _("Boat speed units:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText27->Wrap( -1 );
	fgSizer12->Add( m_staticText27, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );
	...
	fgSizer12->Add( m_staticText28, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );
	...
	fgSizer12->Add( m_staticText29, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );
	...
	fgSizer12->Add( m_staticText30, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );
	...
	sbSizer4->Add( fgSizer12, 1, wxEXPAND, 2 );


	bSizer11->Add( sbSizer4, 1, wxEXPAND, 2 );
	...
	fgSizer15->Add( m_staticText35, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );
	...
	fgSizer14->Add( bSizer13, 1, wxEXPAND, 2 );
	...
	fgSizer17->Add( m_staticText37, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );

	m_spinCtrlDoubleLeewayFactor = new wxSpinCtrlDouble( sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 20, 10, 0.01 );
	...
	fgSizer17->Add( 0, 0, 1, wxEXPAND, 2 );
	...
	fgSizer14->Add( bSizer14, 1, wxEXPAND, 2 );
	...
	fgSizer18->Add( m_staticText39, 0, wxALL, 2 );
	...
	bSizer16->Add( sbSizer7, 1, wxEXPAND, 2 );


	fgSizer14->Add( bSizer16, 1, wxEXPAND, 2 );
	...
	fgSizer20->Add( m_staticText48, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );

	m_spinCtrlAlphaCurrDir = new wxSpinCtrl( sbSizer8->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, 400, 8 );
	m_spinCtrlAlphaCurrDir->SetToolTip( _("Stabilizes the surface current 'arrow' in the chart overlay, bearing compass and also the numerical instruments\nLow values mean high damping") );

	fgSizer20->Add( m_spinCtrlAlphaCurrDir, 0, wxALL, 0 );
	...
	fgSizer14->Add( bSizer18, 1, wxEXPAND, 2 );
	...
	fgSizer14->Add( bSizer19, 1, wxEXPAND, 2 );
	...
	fgSizer14->Add( bSizer20, 1, wxEXPAND, 2 );
	...
	fgSizer201->Add( m_radioBtnExpNKE, 0, wxALL, 2 );


	fgSizer201->Add( 0, 0, 1, wxEXPAND, 2 );
	...
	fgSizer201->Add( m_checkBoxExpPerfData01, 0, wxALL, 2 );
	...
	fgSizer201->Add( m_checkBoxExpPerfData04, 0, wxALL, 2 );
	...
	fgSizer14->Add( bSizer21, 1, wxEXPAND, 2 );
	...
	fgSizerAboutLayout->Add( m_staticTextName, 0, wxALL, 2 );
	...
	fgSizerAboutLayout->Add( m_staticTextNameVal, 0, wxALL, 2 );
	...
	fgSizerAboutLayout->Add( m_staticTextOCPNVersion, 0, wxALL, 2 );
	...
	fgSizer3->Add( m_staticTextOCPNAPIVersionMajor, 0, wxALL, 2 );
	...
	fgSizer3->Add( m_staticTextOCPNAPIVersionMajorVal, 0, wxALL, 2 );
	...
	fgSizer3->Add( m_staticTextOCPNAPIVersionMinor, 0, wxALL, 2 );
	...
	fgSizer3->Add( m_staticTextOCPNAPIVersionMinorVal, 0, wxALL, 2 );


	fgSizerAboutLayout->Add( fgSizer3, 1, wxEXPAND, 2 );

	m_staticTextDate = new wxStaticText( m_panelAbout, wxID_ANY, _("Date:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDate->Wrap( -1 );
	fgSizerAboutLayout->Add( m_staticTextDate, 0, wxALL, 2 );
